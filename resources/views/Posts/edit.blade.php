...
@endsection
<form class="form" action="{{route('update-post')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="form-body">
        ...
        <div class="form-group form-label-group">
            ...
            <select onchange="javascript:handleSelect(this)" name="category_id" id="category" required  class="form-select remove">
